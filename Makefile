...
prog: obj/main.o obj/vec.o obj/widget.o obj/rendertarget.o obj/color.o obj/filter.o obj/keyboard.o\
	  obj/region.o obj/buttons.o obj/drawing.o obj/events.o obj/window.o obj/menu.o obj/editbox.o
	$(CC) -o prog obj/main.o obj/vec.o obj/widget.o obj/rendertarget.o obj/color.o obj/filter.o obj/keyboard.o\
			      obj/region.o obj/buttons.o obj/drawing.o obj/events.o obj/window.o obj/menu.o obj/editbox.o $(SFMLFLAGS)
